...
UPDATE siswa SET tempatlahir = "INDRAMAYU" WHERE nis = "12002406";

SELECT * FROM `siswa` WHERE nis = "12002820";

UPDATE siswa SET tanggallahir = "2005-04-29", alamat = "GUNUNGTUA" WHERE nis = "12002820";
...
SELECT * FROM `siswa` WHERE nilai ORDER BY nilai ASC;

SELECT * FROM `siswa` WHERE nilai ORDER BY nilai DESC;

DELETE FROM siswa WHERE nis = "12002406";
